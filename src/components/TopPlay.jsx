...
const TopChartsCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className="w-full flex flex-row items-center hover:bg-[#3f7263] py-2 p-4 rounded-lg cursor-pointer mb-2">
        ...
        <div className="mt-4 flex flex-col gap-1">
          {topPlays?.map((song, i) => (
            <TopChartsCard 
              ...
              handlePlayClick={() => handlePlayClick(song, songData, i)}
            />
          ))}
        </div>
      </div>
